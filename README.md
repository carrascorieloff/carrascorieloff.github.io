...
<head>
  <meta charset="UTF-8">
  <title>Columna Estratigráfica — Exportación Multi-Formato</title>
  <style>
    body {
    ...
    .layout-lateral .acciones-proyecto,
...
<body>
  ...
  <div class="instrucciones">
    ...
    Código desarrollado por Felipe Carrasco Rieloff
    ...
    function crearPanelEstrato(index) {
      ...
      panel.innerHTML = `
        ...
        <div class="controles">
          ...
          <select class="select-borde-superior">
            ...
            <option value="ondulado_inf_sup_trans" ${estrato.tipoBordeSuperior === 'ondulado_inf_trans' ? 'selected' : ''}>Ondulado con base y techo transparente</option>
            ...
            <option value="vacio_1" ${estrato.tipoBordeSuperior === 'vacio' ? 'selected' : ''}>Vacío, hiato o no visible (1)</option>
            <option value="vacio_2" ${estrato.tipoBordeSuperior === 'vacio' ? 'selected' : ''}>Vacío, hiato o no visible (2)</option>
          </select>
      ...
      const renderizarSimbolosDerecha = () => {
        ...
        estrato.simbolosDerecha.forEach((simboloInfo, idx) => {
          ...
          const nombreSimbolo = selectSimboloDerecha.querySelector(`option[value="${simboloInfo.tipo}"]`)?.textContent || simboloInfo.tipo;
          item.innerHTML = `
            <span>${nombreSimbolo} (${(simboloInfo.proporcionY * 100).toFixed(0)}%)</span>
